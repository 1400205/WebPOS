...
include ("searchPersonToAddEmployee.php");
    ...
    <form class="login-form" method="post" action="">
        <div class="content">
            <div class="header">
                ...
                <span>Enter both First Name and Surname to search for person. This will enable the person to be added as an employee</span>
            </div>
            <fieldset>
